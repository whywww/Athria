import { TEMPLATE_CATALOG_VERSION, type BuiltinSessionTemplate, type SessionTemplate } from "@athria/schemas";

const builtin = (template: SessionTemplate): BuiltinSessionTemplate => ({ ...template, origin: "builtin", catalogVersion: TEMPLATE_CATALOG_VERSION } as BuiltinSessionTemplate);

export const builtinSessionTemplates: BuiltinSessionTemplate[] = [
  builtin({ id: "builtin.easy-run", name: "Easy Run", intent: "Build or maintain low-intensity aerobic capacity at a conversational effort.", domain: "endurance", nodes: [
  ...
  builtin({ id: "builtin.intervals", name: "Intervals", intent: "Develop high-aerobic or event-specific capacity with repeated work and recovery.", domain: "endurance", nodes: [
    { role: "warm_up", variables: ["duration"] },
  ...
  builtin({ id: "builtin.long-run", name: "Long Run", intent: "Develop aerobic endurance and durable time on feet with an optional progressive finish.", domain: "endurance", nodes: [
  ...
  builtin({ id: "builtin.lower-strength-a", name: "Lower Strength A", intent: "Develop or maintain balanced lower-body and trunk strength while allowing exercise choice to vary.", domain: "strength", nodes: [
  ...
  builtin({ id: "builtin.upper-strength-a", name: "Upper Strength A", intent: "Develop or maintain balanced upper-body pushing and pulling strength while allowing exercise choice to vary.", domain: "strength", nodes: [
  ...
  builtin({ id: "builtin.basketball-practice", name: "Basketball High-intensity Practice", intent: "Develop basketball technique, tactical decisions and repeated game-intensity efforts.", domain: "sport_skill", nodes: [
  ...
  builtin({ id: "builtin.mobility-reset", name: "Mobility Reset", intent: "Support recovery through low-load movement, mobility and down-regulation.", domain: "recovery", nodes: [
  ...
  builtin({ id: "builtin.mind-body-reset", name: "Mind-body Reset", intent: "Practice attention, breathing and gentle integrated movement for a low-load reset.", domain: "mind_body", nodes: [
